...
```{r}
pacman::p_load(tidyverse, lubridate, ggthemes, reactable,
reactablefmtr, gt, gtExtras, RODBC)
...
con <- odbcConnectAccess2007('../../Data/hands-on_ex10/Coffee Chain.mdb')
coffeechain <- sqlFetch(con, 'CoffeeChain Query')
write_rds(coffeechain, "../../Data/hands-on_ex10/rds/CoffeeChain.rds")
odbcClose(con)
...
```{r}
coffeechain <- read_rds("../../Data/hands-on_ex10/rds/CoffeeChain.rds")

```

We then aggregate Sales and Budgeted Sales at the Product level.
...
The short red lines in the graph represent the targets for each product, while the bars represent the actual sales. It's very clear to see which product didn't hit the target.
...
This comes to the end of this hands-on exercise. I have learned to plot bullet charts and sparklines using R. Hope you enjoyed it, too!

This is the last hands-on exercise in ISSS608 Visual Analytics. A big thank you to Prof Kam! 🥰
