...
-   [viridis](https://cran.r-project.org/web/packages/viridis/vignettes/intro-to-viridis.html): provide a series of color maps that are designed to improve graph readability for readers with common forms of color blindness and/or color vision deficiency.

-   [lubridate](https://lubridate.tidyverse.org/): makes it easier to handle date and time data in R

-   [ggthemes](https://cran.r-project.org/web/packages/ggthemes/index.html): provides 'ggplot2' themes.
...
-   [data.table](https://cran.r-project.org/web/packages/data.table/index.html): makes it faster to aggregate and modify large data.

-   [CGPfunctions](https://cran.r-project.org/web/packages/CGPfunctions/index.html): miscellaneous functions useful for teaching statistics as well as actually practicing the art.

-   [ggHoriPlot](https://cran.r-project.org/web/packages/ggHoriPlot/vignettes/ggHoriPlot.html): makes it easy to build horizon plots in ggplot2.
